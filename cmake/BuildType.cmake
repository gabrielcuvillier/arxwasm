...
if(MSVC)
	...
	if(SET_OPTIMIZATION_FLAGS)
      ...
      add_ldflag("--shell-file ../data/emscripten/shell.html")
      add_ldflag("-o arxwasm.html")
      ...
      add_ldflag("-s USE_REGAL=1")
      add_ldflag("-s USE_LIBPNG=1")
      add_ldflag("-s USE_FREETYPE=1")
      add_ldflag("-s USE_ZLIB=1")
      add_ldflag("-s USE_SDL=2")
      add_ldflag("-s EXIT_RUNTIME=0")
      add_ldflag("-s ENVIRONMENT=web")
      add_ldflag("-lopenal")
	  endif()
