...
if(MSVC)
  ...
  if(PNACL)
	...
	if(SET_OPTIMIZATION_FLAGS)
	  ...
	  add_ldflag("-g")
	  add_cxxflag("-fwrapv")
  add_cxxflag("-s ASSERTIONS=0")
      add_ldflag("-s ASSERTIONS=0")
  add_cxxflag("-s STACK_OVERFLOW_CHECK=0")
      add_ldflag("-s STACK_OVERFLOW_CHECK=0")
      #add_cxxflag("-s ASSERTIONS=2")
      #add_cxxflag("-s STACK_OVERFLOW_CHECK=2")
  add_cxxflag("-s SAFE_HEAP=0")
	  add_ldflag("-s SAFE_HEAP=0")
	  #add_ldflag("-s DOUBLE_MODE=0")
  #add_cxxflag("-s UNALIGNED_MEMORY=1")
	  #add_ldflag("-s UNALIGNED_MEMORY=1")
  #add_ldflag("-s LEGACY_GL_EMULATION=1")
     ...
     #add_ldflag("-s GL_FFP_ONLY=1")
	  ...
	  #add_ldflag("-s USE_WEBGL2=1")
      #add_cxxflag("-s BINARYEN_TRAP_MODE=js")
